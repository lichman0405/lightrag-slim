...
from lightrag_slim.base import (
    BaseGraphStorage,
    BaseKVStorage,
    BaseVectorStorage,
    DeletionResult,
...
from lightrag_slim.constants import (
    DEFAULT_CHUNK_TOP_K,
...
from lightrag_slim.exceptions import PipelineCancelledException
from lightrag_slim.kg import (
    verify_storage_implementation,
)
from lightrag_slim.kg.shared_storage import (
    get_data_init_lock,
...
from lightrag_slim.namespace import NameSpace
from lightrag_slim.operate import (
...
from lightrag_slim.prompt import PROMPTS
from lightrag_slim.types import KnowledgeGraph
from lightrag_slim.utils import (
    EmbeddingFunc,
    TiktokenTokenizer,
    Tokenizer,
...
class LightRAG:
    ...
    async def initialize_storages(self):
        ...
        if self._storages_status == StoragesStatus.CREATED:
            ...
            from lightrag_slim.kg.shared_storage import initialize_pipeline_status
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from lightrag_slim.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from lightrag_slim.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from lightrag_slim.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from lightrag_slim.kg.json_doc_status_impl import JsonDocStatusStorage

            return JsonDocStatusStorage
        else:
            raise ValueError(
                f"Unknown storage: '{storage_name}'. "
                f"lightrag-slim only supports: JsonKVStorage, NanoVectorDBStorage, "
                f"NetworkXStorage, JsonDocStatusStorage"
            )
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from lightrag_slim.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from lightrag_slim.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from lightrag_slim.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from lightrag_slim.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from lightrag_slim.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from lightrag_slim.utils_graph import aedit_relation
    ...
    async def acreate_entity(
        ...
        """
        from lightrag_slim.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from lightrag_slim.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from lightrag_slim.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from lightrag_slim.utils import aexport_data as utils_aexport_data
