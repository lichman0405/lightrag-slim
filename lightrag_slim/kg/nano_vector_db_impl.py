...
from lightrag_slim.base import BaseVectorStorage
...
class NanoVectorDBStorage(BaseVectorStorage):
    def __post_init__(self):
        ...
        self._client: NanoVectorDB = None  # type: ignore[assignment]
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        if len(embeddings) == len(list_data):
            ...
            client.upsert(datas=list_data)  # type: ignore[arg-type]
        else:
