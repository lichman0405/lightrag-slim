...
from lightrag_slim.exceptions import StorageNotInitializedError
...
class JsonKVStorage(BaseKVStorage):
    def __post_init__(self):
        ...
        self._data: dict[str, Any] = None  # type: ignore[assignment]
        self._storage_lock: NamespaceLock = None  # type: ignore[assignment]
    ...
    async def _migrate_legacy_cache_structure(self, data: dict) -> dict:
        ...
        """
        from lightrag_slim.utils import generate_cache_key
